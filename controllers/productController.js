...
//     number = 5, // Default number of items per page
//   } = req.query;
...
//   if (seasonal) queryObject.seasonal = seasonal === "true";
//   if (freeShipping) queryObject.freeShipping = freeShipping === "true";

//   // Handle string filters
//   if (brand) queryObject.brand = brand;
//   if (category) queryObject.category = category;
//   if (colors) queryObject.colors = colors;
...
// const getAllProductsSample = async (req, res) => {
//   // a) filtering
...
//     if (skip >= numProducts) throw new NotFoundError("Page is not exist");
//   }
